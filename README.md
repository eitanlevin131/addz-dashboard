...
בדיקת ה־E2E בונה ומריצה את גרסת ה־Production, יוצרת רשומות זמניות ומבודדות במסד הנתונים, ובודקת כניסה, בחירת לקוח, טווח תאריכים, סנכרון, דוחות, גאנט ושאלת AI עם מקורות. Flashy ו־OpenAI מוחלפים בשירותים מקומיים דטרמיניסטיים, והרשומות הזמניות נמחקות בסיום.
